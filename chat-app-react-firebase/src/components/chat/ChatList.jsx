        ...
        return (
            <div className='space-y-3'>
                {Array.from({ length: count }).map((_, index) => (
                    <div
                        key={index}
                        className="group p-4 rounded-md border border-gray-100 animate-pulse"
                    >
                ...
                <div className='p-6'>
                    ...
                    <div className='flex items-center justify-between mb-6'>
                        <div>
                            ...
                            <p className='text-sm text-gray-500 mt-1'>
                                {loading ? (
                                    <span className="inline-block h-3 bg-gray-200 rounded w-32 animate-pulse"></span>
                                ) : (
                                    <>
            ...
            <>
                ...
                <div className='flex flex-row gap-3 justify-center'>
                    <button
                        ...
                        className='w-36 px-4 py-3 bg-white text-gray-700 border border-gray-200 rounded-md flex items-center justify-center transition-all duration-200 hover:bg-black hover:text-white hover:border-gray-300 shadow-sm hover:shadow-md font-medium'
                    >
                        Search Friends
                    </button>
                </div>
